...
namespace Package\Difference\Fun\Parse\Controller;
...
class Cli extends Controller {
    ...
    const INFO = [
        '{{binary()}} difference_fun/parse                   | Parse options',
        '{{binary()}} difference_fun/parse setup             | Setup Parse',
    ];
    ...
    private static function scan(App $object): array
    {
        ...
        foreach($read as $nr => $file){
            ...
            $part = mb_substr($file->url, mb_strlen($url));
